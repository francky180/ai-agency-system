...
const steps = [
  {
    ...
    desc: "Get instant access to the complete AI agency infrastructure. Website, marketing engine, automation — all ready to go.",
    metric: "< 2 min",
    metricLabel: "to access",
  },
  {
    num: "02",
    title: "Follow the Process",
    desc: "Walk through the structured guide. Install, configure, and launch. Every step is documented. No guesswork.",
    metric: "< 30 min",
  ...
  },
  {
    num: "03",
    title: "Scale Results",
    desc: "Deploy your agency, start closing clients, and let AI handle execution. The system compounds with every project.",
    metric: "Day 1",
    ...
    <section id="how-it-works" className="relative px-6 py-28 flex flex-col items-center">
      ...
      >
        ...
        <p className="mt-4 text-muted max-w-md mx-auto">
          From purchase to running agency in under 30 minutes.
        </p>
      </motion.div>
      ...
      <div className="relative z-10 grid w-full max-w-5xl gap-6 sm:grid-cols-3">
        {steps.map((step, i) => (
          <motion.div
            ...
            className="group relative rounded-2xl border border-border bg-card p-8 transition-all duration-300 hover:border-accent/20 hover:bg-card-hover"
          >
            {/* Step indicator */}
